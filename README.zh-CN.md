...
> ⚠️ 个人自用工具，非 Anthropic 官方产品。支持 **Terminal.app** 与 **iTerm2**（可在设置中选择目标或自动检测）。
...
- **Terminal.app 与 iTerm2**：均可发送（或自动检测）；在设置中选择目标终端
...
- **自动化**：控制 Finder、Terminal.app 和/或 iTerm2（枚举窗口/标签、发送内容）
